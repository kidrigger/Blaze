...
namespace blaze
{
	...
	public:
         ...
         * @{
         */
		inline const VkDescriptorSet& get_descriptorSet() const { return descriptorSet.get(); }
		inline const MaterialPushConstantBlock& get_pushConstantBlock() const { return pushConstantBlock; }
        /**
         * @}
         */
    };
	...
	struct Node
	{
        ...
        /**
         * @fn 	Node(const glm::vec3& trans, const glm::quat& rot, const glm::vec3& sc, const std::vector<int>& children, const std::pair<int, int> primitive_range)
         *
         ...
         */
		Node(const glm::vec3& trans, const glm::quat& rot, const glm::vec3& sc, const std::vector<int>& children, const std::pair<int, int> primitive_range) noexcept;
	...
	public:
        ...
        /**
         * @fn Model(const Renderer& renderer, const std::vector<int>& top_level_nodes, std::vector<Node>& nodes, std::vector<Primitive>& prims, std::vector<Material>& mats, IndexedVertexBuffer<Vertex>&& ivb)
         *
         ...
         */
		Model(const Renderer& renderer, const std::vector<int>& top_level_nodes, std::vector<Node>& nodes, std::vector<Primitive>& prims, std::vector<Material>& mats, IndexedVertexBuffer<Vertex>&& ivb) noexcept;
