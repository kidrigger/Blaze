...
public:
	 ...
	 * @{
	 */
	Model2(Model2&& other) = delete;
	Model2& operator=(Model2&& other) = delete;
	Model2(const Model2& other) = delete;
	Model2& operator=(const Model2& other) = delete;
	/**
	 * @}
	 */
