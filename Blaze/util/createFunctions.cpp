...
VkImageView createImageView(VkDevice device, VkImage image, VkImageViewType viewType, VkFormat format,
							VkImageAspectFlags aspect, uint32_t miplevels, uint32_t numLayers, uint32_t baseLayer)
{
	VkImageView view;
...
VkRenderPass createRenderPassMultiView(VkDevice device, uint32_t viewMask, VkFormat colorAttachmentFormat,
									   VkFormat depthAttachmentFormat, VkImageLayout finalLayout,
									   VkImageLayout initialLayout, VkAttachmentLoadOp colorLoadOp)
{
...
VkRenderPass createRenderPass(VkDevice device, VkFormat colorAttachmentFormat, VkFormat depthAttachmentFormat,
							  VkImageLayout finalLayout, VkImageLayout initialLayout, VkAttachmentLoadOp colorLoadOp)
{
	std::vector<VkAttachmentDescription> attachments;
	VkAttachmentReference colorAttachmentRef;
	uint32_t idx = 0;
...
VkPipeline createGraphicsPipeline(VkDevice device, VkPipelineLayout pipelineLayout, VkRenderPass renderPass,
								  ...
								  const std::vector<VkDynamicState>& dynamicStates, VkCullModeFlags cullMode,
								  VkBool32 depthTest, VkBool32 depthWrite, VkCompareOp depthCompareOp,
...
VkSampler createSampler(VkDevice device, uint32_t miplevels, VkSamplerAddressMode addressMode, VkBool32 anisotropy)
{
